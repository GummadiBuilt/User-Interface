...
export class ViewApplicantsComponent implements OnInit {
  ...
  public rowData: any[] = [
    { company_name: 'Abhi Constructions', applicant_rank: '', justification_note: 'note 1' },
    { company_name: 'Bhargav Constructions', applicant_rank: '', justification_note: 'note 2' },
    { company_name: 'Arun Constructions', applicant_rank: '', justification_note: 'note 3' },
    { company_name: 'Raj Constructions', applicant_rank: '', justification_note: 'note 4' },
  ]
